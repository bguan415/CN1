...
// Four buttons to show stats by size? A search bar to find a specific timer? A log? Settings?
    ...
    public Form statsForm() {
        ...
        TextField searchField = new TextField("", "Search specific task"); // <1>
        ...
        // Print Placeholder for general report
        // TODO: create populate function to cycle through all specified tasks
        // TODO: print pretty tasks?
        try {
        ...
        /*
        hi.add(padRightPadSpace("ECS160", 45)+padRightPadSpace("L", 4)+"6:32::47").
                add("ECS 160 Prj2").
                add("Chores").
                add("Errands").
                add("Exercise").
        ...
        Button filterSize = new Button("Size");
        filterSize.getAllStyles().setFgColor(0x2e3030);
        filterSize.getAllStyles().setBorder(Border.createLineBorder(6, 0x435059));
        filterSize.getAllStyles().setBgTransparency(255);
        filterSize.getAllStyles().setBgColor(0x6b7e8c);
        filterSize.getStyle().setAlignment(CENTER);
        filterSize.setIcon(FontImage.createMaterial(FontImage.MATERIAL_FILTER_ALT, s));
        filterSize.addActionListener((e) -> changeSize(filterSize));
